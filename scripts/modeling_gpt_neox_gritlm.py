...
class GPTNeoXAttention(nn.Module):
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None, is_causal=False):
...
class GPTNeoXForCausalLM(GPTNeoXPreTrainedModel):
    ...
    def forward(
        ...
        >>> is_causal = True
        >>> model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b", config=config, is_causal=is_causal)
